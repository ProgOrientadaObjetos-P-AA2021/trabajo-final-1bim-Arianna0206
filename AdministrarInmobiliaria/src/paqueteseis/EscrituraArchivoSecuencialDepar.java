 ...
 * @author macbookair
 */
public class EscrituraArchivoSecuencialDepar {
    ...
    public EscrituraArchivoSecuencialDepar(String nombreArc) {
    ...
    public void establecerLista() {
        LecturaArchivoSecuencialDepar l = new LecturaArchivoSecuencialDepar(obtenerNombreArchivo());
